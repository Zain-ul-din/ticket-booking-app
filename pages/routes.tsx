...
import { Plus, ArrowLeft, MapPin, Trash2, ArrowRight, Bus, Car } from 'lucide-react';
...
export default function RoutesPage() {
  ...
  const terminalRoutes = routes.filter(route => route.origin === terminalInfo?.city);
      ...
      <main className="container max-w-4xl mx-auto px-4 py-8">
        {!terminalInfo?.city ? (
          <div className="text-center py-16">
            ...
            <p className="text-muted-foreground mb-6">Please complete terminal setup first</p>
          ...
          <div className="text-center py-16">
            ...
            <p className="text-muted-foreground mb-6">Add your first route with fare pricing from {terminalInfo.city}</p>
