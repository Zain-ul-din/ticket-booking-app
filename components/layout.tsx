  ...
  return (
    <div className="h-screen flex flex-col">
      ...
      <div className="flex flex-col h-[calc(100%-3rem)]">
        <div
          className={`h-[calc(100%-3rem)] duration-75 fixed bg-white ${
            navbarExpend ? "w-52 scrollbar shadow-lg" : "w-16 scrollbar_hide"
          } overflow-y-auto`}
          onMouseEnter={() => {
            setNavbarExpend(true);
          }}
          onMouseLeave={() => {
            setNavbarExpend(false);
          }}
        >
